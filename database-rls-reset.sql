-- ============================================================================
-- APPLIANCE MANAGER - RESET AND RECREATE RLS POLICIES
-- ============================================================================
-- This drops all existing policies and recreates them
-- ============================================================================
...
-- Drop policies for job_visits
DROP POLICY IF EXISTS "Authenticated users can view job_visits" ON job_visits;
DROP POLICY IF EXISTS "Authenticated users can insert job_visits" ON job_visits;
DROP POLICY IF EXISTS "Authenticated users can update job_visits" ON job_visits;
DROP POLICY IF EXISTS "Authenticated users can delete job_visits" ON job_visits;

-- Drop policies for tour_log
DROP POLICY IF EXISTS "Authenticated users can view tour_log" ON tour_log;
DROP POLICY IF EXISTS "Authenticated users can insert tour_log" ON tour_log;
DROP POLICY IF EXISTS "Authenticated users can update tour_log" ON tour_log;
DROP POLICY IF EXISTS "Authenticated users can delete tour_log" ON tour_log;

-- Drop policies for tour_summary
DROP POLICY IF EXISTS "Authenticated users can view tour_summary" ON tour_summary;
DROP POLICY IF EXISTS "Authenticated users can insert tour_summary" ON tour_summary;
DROP POLICY IF EXISTS "Authenticated users can update tour_summary" ON tour_summary;
DROP POLICY IF EXISTS "Authenticated users can delete tour_summary" ON tour_summary;

-- Drop policies for parts_master
DROP POLICY IF EXISTS "Authenticated users can view parts_master" ON parts_master;
DROP POLICY IF EXISTS "Authenticated users can insert parts_master" ON parts_master;
DROP POLICY IF EXISTS "Authenticated users can update parts_master" ON parts_master;
DROP POLICY IF EXISTS "Authenticated users can delete parts_master" ON parts_master;

-- Drop policies for parts_transactions
DROP POLICY IF EXISTS "Authenticated users can view parts_transactions" ON parts_transactions;
DROP POLICY IF EXISTS "Authenticated users can insert parts_transactions" ON parts_transactions;
DROP POLICY IF EXISTS "Authenticated users can update parts_transactions" ON parts_transactions;
DROP POLICY IF EXISTS "Authenticated users can delete parts_transactions" ON parts_transactions;

-- Drop policies for parts_orders
DROP POLICY IF EXISTS "Authenticated users can view parts_orders" ON parts_orders;
DROP POLICY IF EXISTS "Authenticated users can insert parts_orders" ON parts_orders;
DROP POLICY IF EXISTS "Authenticated users can update parts_orders" ON parts_orders;
DROP POLICY IF EXISTS "Authenticated users can delete parts_orders" ON parts_orders;

-- Drop policies for parts_order_items
DROP POLICY IF EXISTS "Authenticated users can view parts_order_items" ON parts_order_items;
DROP POLICY IF EXISTS "Authenticated users can insert parts_order_items" ON parts_order_items;
DROP POLICY IF EXISTS "Authenticated users can update parts_order_items" ON parts_order_items;
DROP POLICY IF EXISTS "Authenticated users can delete parts_order_items" ON parts_order_items;

-- Drop policies for parts_cross_reference
DROP POLICY IF EXISTS "Authenticated users can view parts_cross_reference" ON parts_cross_reference;
DROP POLICY IF EXISTS "Authenticated users can insert parts_cross_reference" ON parts_cross_reference;
DROP POLICY IF EXISTS "Authenticated users can update parts_cross_reference" ON parts_cross_reference;
DROP POLICY IF EXISTS "Authenticated users can delete parts_cross_reference" ON parts_cross_reference;

-- Drop policies for parts_xref_groups
DROP POLICY IF EXISTS "Authenticated users can view parts_xref_groups" ON parts_xref_groups;
DROP POLICY IF EXISTS "Authenticated users can insert parts_xref_groups" ON parts_xref_groups;
DROP POLICY IF EXISTS "Authenticated users can update parts_xref_groups" ON parts_xref_groups;
DROP POLICY IF EXISTS "Authenticated users can delete parts_xref_groups" ON parts_xref_groups;

-- Drop policies for parts_ai_data
DROP POLICY IF EXISTS "Authenticated users can view parts_ai_data" ON parts_ai_data;
DROP POLICY IF EXISTS "Authenticated users can insert parts_ai_data" ON parts_ai_data;
DROP POLICY IF EXISTS "Authenticated users can update parts_ai_data" ON parts_ai_data;
DROP POLICY IF EXISTS "Authenticated users can delete parts_ai_data" ON parts_ai_data;
...
-- Drop policies for model_database
DROP POLICY IF EXISTS "Authenticated users can view model_database" ON model_database;
DROP POLICY IF EXISTS "Authenticated users can insert model_database" ON model_database;
DROP POLICY IF EXISTS "Authenticated users can update model_database" ON model_database;
DROP POLICY IF EXISTS "Authenticated users can delete model_database" ON model_database;

-- Drop policies for model_compilation_items
DROP POLICY IF EXISTS "Authenticated users can view model_compilation_items" ON model_compilation_items;
DROP POLICY IF EXISTS "Authenticated users can insert model_compilation_items" ON model_compilation_items;
DROP POLICY IF EXISTS "Authenticated users can update model_compilation_items" ON model_compilation_items;
DROP POLICY IF EXISTS "Authenticated users can delete model_compilation_items" ON model_compilation_items;

-- Drop policies for common_issues
DROP POLICY IF EXISTS "Authenticated users can view common_issues" ON common_issues;
DROP POLICY IF EXISTS "Authenticated users can insert common_issues" ON common_issues;
DROP POLICY IF EXISTS "Authenticated users can update common_issues" ON common_issues;
DROP POLICY IF EXISTS "Authenticated users can delete common_issues" ON common_issues;

-- Drop policies for labor_adjustments
DROP POLICY IF EXISTS "Authenticated users can view labor_adjustments" ON labor_adjustments;
DROP POLICY IF EXISTS "Authenticated users can insert labor_adjustments" ON labor_adjustments;
DROP POLICY IF EXISTS "Authenticated users can update labor_adjustments" ON labor_adjustments;
DROP POLICY IF EXISTS "Authenticated users can delete labor_adjustments" ON labor_adjustments;

-- Drop policies for specialty_tools
DROP POLICY IF EXISTS "Authenticated users can view specialty_tools" ON specialty_tools;
DROP POLICY IF EXISTS "Authenticated users can insert specialty_tools" ON specialty_tools;
DROP POLICY IF EXISTS "Authenticated users can update specialty_tools" ON specialty_tools;
DROP POLICY IF EXISTS "Authenticated users can delete specialty_tools" ON specialty_tools;

-- Drop policies for storage_locations
DROP POLICY IF EXISTS "Authenticated users can view storage_locations" ON storage_locations;
...
-- Drop policies for job_history
DROP POLICY IF EXISTS "Authenticated users can view job_history" ON job_history;
DROP POLICY IF EXISTS "Authenticated users can insert job_history" ON job_history;
DROP POLICY IF EXISTS "Authenticated users can update job_history" ON job_history;
DROP POLICY IF EXISTS "Authenticated users can delete job_history" ON job_history;

-- Drop policies for callbacks
DROP POLICY IF EXISTS "Authenticated users can view callbacks" ON callbacks;
DROP POLICY IF EXISTS "Authenticated users can insert callbacks" ON callbacks;
DROP POLICY IF EXISTS "Authenticated users can update callbacks" ON callbacks;
DROP POLICY IF EXISTS "Authenticated users can delete callbacks" ON callbacks;
