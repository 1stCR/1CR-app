-- ============================================================================
-- APPLIANCE MANAGER - COMPLETE RESET AND REBUILD
-- ============================================================================
-- This will drop ALL tables and recreate them from scratch
-- WARNING: This will delete all data! Only run if you're okay losing test data
-- ============================================================================
...
DROP TABLE IF EXISTS parts_ai_data CASCADE;
DROP TABLE IF EXISTS parts_master CASCADE;
DROP TABLE IF EXISTS parts_orders CASCADE;
DROP TABLE IF EXISTS shipments CASCADE;
DROP TABLE IF EXISTS model_database CASCADE;
DROP TABLE IF EXISTS common_issues CASCADE;
DROP TABLE IF EXISTS labor_adjustments CASCADE;
DROP TABLE IF EXISTS specialty_tools CASCADE;
