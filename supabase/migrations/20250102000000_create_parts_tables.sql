-- Stage 5: Parts Inventory Core - Database Tables
-- Created: 2025-01-02
...
CREATE INDEX IF NOT EXISTS idx_storage_locations_parent ON storage_locations(parent_location_id);
...
CREATE INDEX IF NOT EXISTS idx_parts_in_stock ON parts_master(in_stock);
...
CREATE INDEX IF NOT EXISTS idx_transactions_type ON parts_transactions(type);
...
CREATE INDEX IF NOT EXISTS idx_job_parts_transaction ON job_parts(transaction_id);
